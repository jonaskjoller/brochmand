...
filename = file_list[int(input('Select file by entering number: '))]
...
foldername = dir_list[int(input('Select subfolder by entering number: '))]
...
for items in file_list_files:
    ...
    counter += 1
    print('Completed',counter, 'out of',len(file_list_files))
